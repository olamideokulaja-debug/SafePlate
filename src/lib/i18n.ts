...
export const STRINGS: Record<string, Record<string, string>> = {
  en: {
    ...
    hero_eyebrow: 'Statewide, live compliance', hero_title: 'Every plate and glass in Lagos, backed by verified safety.',
    hero_lede: 'SafePlate registers, tests, certifies and monitors food handlers and the safety of drinking water and beverages across Lagos State, through accredited laboratories, with payments held in escrow and released only on approved results.',
    cta_register: 'Register as a food handler', cta_verify: 'Verify a certificate',
    chip_active: 'active certificates', chip_compliance: 'compliance', chip_secure: 'Escrow-secured payments', hero_model: 'One system for food, water and drink safety, self-sustaining, with no hidden charges.',
  ...
  yo: {
    ...
    hero_eyebrow: 'Ìbámu tí ń lọ lọ́wọ́ kákiri ìpínlẹ̀', hero_title: 'Gbogbo àwo àti ife ní Èkó, pẹ̀lú ààbò tí a ti ṣàyẹ̀wò.',
    hero_lede: 'SafePlate ń forúkọsílẹ̀, ń ṣàyẹ̀wò, ń fúnni ní ìwé-ẹ̀rí, ó sì ń bójútó àwọn olùtọ́jú oúnjẹ àti ààbò omi mímu àti ohun mímu ní Ìpínlẹ̀ Èkó, nípasẹ̀ àwọn ilé-ìwádìí tí a fọwọ́sí, pẹ̀lú owó tí a fi pamọ́ tí a ó tú sílẹ̀ lẹ́yìn ìfọwọ́sí àbájáde.',
  ...
  ig: {
    ...
    hero_title: 'Efere na iko obula na Lagos, nwere nchekwa e nyochara.',
    hero_lede: 'SafePlate na-edebanye aha, na-anwale, na-enye asambodo ma na-elekota ndi na-ejikwa nri na nchekwa mmiri onunu na ihe onunu na Steeti Lagos, site na ulo nyocha akwadoro, ebe a na-edobe ugwo na escrow ma hapu ya naani mgbe a kwadoro nsonaazu.',
  ...
  pcm: {
    ...
    hero_title: 'Every plate and cup for Lagos, na verified safety dey behind am.',
    hero_lede: 'SafePlate dey register, test, certify and monitor food handlers plus the safety of drinking water and drinks for Lagos State, through labs wey dem approve, with payment wey dey inside escrow wey dem go only release after dem approve result.',
